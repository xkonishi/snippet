...
import jp.co.canonits.prognerex.aptemplate_desktopaplike.CC3030.page.Foo;
...
//    }
    protected void select(Foo foo, AbstractTree<Foo> tree, final AjaxRequestTarget targetOptional)
    {
        if (selected != null)
        {
            tree.updateNode(selected.getObject(), targetOptional);
